...
const struct ConverterConfig ConverterConfig_default = { .converter_mode = 100u,
							 ...
							 .LUT_inp_efficiency_n8 = { { 0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u },
...
const struct HarvesterConfig HarvesterConfig_default = { .algorithm = 0u,
							 .hrv_mode = 200u,
							 .window_size = 201u,
							 .voltage_uV = 202u,
							 .voltage_min_uV = 203u,
...
const struct ProtoMsg ProtoMsg_default = { .id = 0u, .unread = 0u, .type = 0u, .value = { 0u, 0u } };

const struct SyncMsg SyncMsg_default = {
	.id = 0u,
	.unread = 0u,
	.type = 0u,
	.buffer_block_period = 0u,
	.analog_sample_period = 0u,
