...
BUFFER_IV_INP_SAMPLES_N: int = 2**20  # for ~10s, must be 2^n
BUFFER_IV_INP_INTERVAL_S: float = BUFFER_IV_INP_SAMPLES_N * SAMPLE_INTERVAL_NS / 1e9
BUFFER_IV_OUT_SAMPLES_N: int = 600_000  # ~6s
BUFFER_IV_OUT_INTERVAL_S: float = BUFFER_IV_OUT_SAMPLES_N * SAMPLE_INTERVAL_NS / 1e9
BUFFER_GPIO_SAMPLES_N: int = 3_000_000
BUFFER_GPIO_INTERVAL_S: float = BUFFER_GPIO_SAMPLES_N / 1.2e6
BUFFER_UTIL_SAMPLES_N: int = 400
BUFFER_UTIL_INTERVAL_S: float = BUFFER_UTIL_SAMPLES_N / 10
